...
T = TypeVar("T", bound="DatabaseChecksumV2Response200")


@_attrs_define
class DatabaseChecksumV2Response200:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        database_checksum_v2_response_200 = cls(
            id=id,
            format_=format_,
            checksums=checksums,
        )

        database_checksum_v2_response_200.additional_properties = d
        return database_checksum_v2_response_200
